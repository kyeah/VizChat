...
These functions are unnecessary because the basic keypress functions are already defined. Just have to change the frame and status(direction) (I put pseudocode in updateSprite yo)

still have to check if yVelocity != 0, set frame to jumping frame (somewhere)

----------------
  KEVIN'S NOTES
---------------*/

/*======== animateSprite(s, imagemap) ==========

Animates sprite based on key pressed

====================*/
/*
void animateSprite(Sprite* s, somekey ){
